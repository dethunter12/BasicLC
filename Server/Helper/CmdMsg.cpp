...
void HelperNameChangeRepMsg(CNetMsg::SP& msg, char bguild, int charindex, const char* name, MSG_EX_NAMECHANGE_ERROR_TYPE error, int itemIdx)
{
	msg->Init(MSG_HELPER_COMMAND);
...
void HelperNewGuildPointUpdateMsg( CNetMsg::SP& msg, int charindex, int guildindex, LONGLONG  guildpoint ) //RomeoST Adjust
{
	msg->Init( MSG_HELPER_COMMAND );
...
void HelperNewGuildMemberPointSaveMsg( CNetMsg::SP& msg, int charindex, int guildindex, LONGLONG  memberpoint ) //RomeoST Adjust
{
	msg->Init( MSG_HELPER_COMMAND );
