...
void HelperNewGuildPointUpdateMsg( CNetMsg::SP& msg, int charindex, int guildindex, LONGLONG  guildpoint );
void HelperNewGuildMemberPointSaveMsg(CNetMsg::SP& msg, int charindex, int guildindex, LONGLONG  memberpoint);
