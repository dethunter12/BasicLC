...
//dethunter12 add new function
inline void CharCurrHP(CNetMsg::SP& msg, int index, int max_hp, int hp)
{
	charCurrHPMP* packet = reinterpret_cast<charCurrHPMP*>(msg->m_buf);
	packet->type = MSG_UPDATE_DATA_FOR_CLIENT;
	packet->subType = MSG_SUB_UPDATE_CHAR_CURR_HP;
	packet->charIndex = index;
	packet->maxHp = max_hp;
	packet->hp = hp;;
	msg->setSize(sizeof(charCurrHPMP));
}
#endif
}
//////////////////////////////////////////////////////////////////////////
