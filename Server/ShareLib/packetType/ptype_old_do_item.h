...
struct doItemOpenBox : public pTypeBase
{
	unsigned short		tab;
	unsigned short		invenIndex;
	int					count;
...
struct doItemDelLegacySeal : public pTypeBase
{
	unsigned short		gear_wearPos;
	int					gear_virtualIndex;
	unsigned short		jam_tab;
	unsigned short		jam_invenIndex;
	int					jam_virtualIndex;
};
...
inline void makeMasterStone(CNetMsg::SP& msg, int random_success, int error, int percent,int max_attack)
{
