...
void GuildMemberListRep( CNetMsg::SP& msg, int membercount, int* membercharindex, LONGLONG* cumulatePoint, const char CharName[][MAX_CHAR_NAME_LENGTH  + 1], const char PositionName[][GUILD_POSITION_NAME+1], char* job, char* job2, int* level, int* position, CGuild* guild, int* logout_date ); //Adjust RomeoST
...
void GuildPointInfo(CNetMsg::SP& msg, LONGLONG  guildpoint); //dethunter12
...
void HelperSaveGuildPointMsg(CNetMsg::SP& msg, int guildindex, LONGLONG  guildpoint ); //RomeoST ADjust
void HelperSaveGuildMemberPointMsg( CNetMsg::SP& msg, int guildindex, int charindex, LONGLONG  GuildMemberPoint ); //RomeoST ADjust
