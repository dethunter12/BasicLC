...
bool CAssistList::DecreaseTime(CCharacter* ch, LONGLONG* changestate)
{
	...
	while ((data = dataNext))
	{
		...
		case 12195: //dethunter12 add 3/8/2023
	   //we might need to add the affinity boosters here too..
			bSkip = true;
			break;
...
void CAssistList::Apply(CCharacter* ch, ASSISTVALUE* addition, ASSISTVALUE* rate, LONGLONG* state)
{
	...
	for (p = m_head; p; p = p->m_next)
	{
		...
		case 14007:
			...
			break ;		// 행운 주문서
		case 15209:
			addition->hcGoldPlus_15209 = true;
			bSkip = true;
			break;
		...
		case 7346:
			...
			break;	// 아이리스의 열정
		case 16668:
			addition->hcCashPetExpUp_16668 = true;
			bSkip = true;
			break;
		case 16669:
			addition->hcCashPetExpUp_16669 = true;
			bSkip = true;
			break;
		case 16670:
			addition->hcSepSPPrem_Cash = true;
			bSkip = true;
			break;
#ifdef CUBE_RANKING_12202022
		case 17189:
			addition->hcCubePointUp_17189 = true;
			bSkip = true;
			break;
		case 17190:
