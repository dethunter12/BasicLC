...
bool Inventory::isUsable()
{
	...
	else if (tab_ == INVENTORY_TAB_CASH_3)
	{
		return owner_->m_TimerItem.isCashInventory_3();
	}
	else if (tab_ == INVENTORY_TAB_CASH_4)
	{
		return owner_->m_TimerItem.isCashInventory_4();
	}
	else if (tab_ == INVENTORY_TAB_CASH_5)
	{
		return owner_->m_TimerItem.isCashInventory_5();
	}
	else if (tab_ == INVENTORY_TAB_CASH_6)
	{
		return owner_->m_TimerItem.isCashInventory_6();
	}
	return false;
}
	...
	, error_no_(ERR_INENT_NO_ERROR)
{
	...
	inven_[INVENTORY_TAB_CASH_3].Init(owner_, INVENTORY_TAB_CASH_3, ITEM_COUNT_IN_INVENTORY_CASH_3, true, false);
	inven_[INVENTORY_TAB_CASH_4].Init(owner_, INVENTORY_TAB_CASH_4, ITEM_COUNT_IN_INVENTORY_CASH_4, true, false);
	inven_[INVENTORY_TAB_CASH_5].Init(owner_, INVENTORY_TAB_CASH_5, ITEM_COUNT_IN_INVENTORY_CASH_5, true, false);
	inven_[INVENTORY_TAB_CASH_6].Init(owner_, INVENTORY_TAB_CASH_6, ITEM_COUNT_IN_INVENTORY_CASH_6, true, false);
...
void InventoryManager::sort()//dethunter12 invenetory sort adjust
{
	for (int i = INVENTORY_TAB_NORMAL; i < INVENTORY_TAB_STASH; i++)
	{
		Inventory& pInven = inven_[i];
		pInven.sort();
	}
