...
//  virtual void Write_net_brief(CNetworkMessage *ostr) {};
  ...
  virtual FLOAT SouthLC_01() { return 0.0f; };//Cloud ant-hack
  virtual SBYTE SouthLC_03() { return 0; };//Cloud ant-hack
  virtual FLOAT SouthLC_04() { return 0.0f; };//Cloud ant-hack												  
