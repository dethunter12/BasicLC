...
//	cha_pSecondSummon	= NULL;
	...
	cha_maxhp = 0; //dethunter12
	cha_hp = 0; //dethunter12
	cha_wins = 0;
	cha_loses = 0;
	cha_color_name = 0;
...
CCharacterTarget::CCharacterTarget(const CCharacterTarget &other)
{
	...
	cha_wins = other.cha_wins;
	cha_loses = other.cha_loses;
	cha_color_name = other.cha_color_name;
...
void CCharacterTarget::SetData( INDEX index, INDEX type, CTString &name, CEntity *pEntity, SBYTE sbyLayer,  UWORD state, SLONG pkstate, INDEX colorName, INDEX wins, INDEX loses)
{	
	m_nIdxServer = index;
	m_nType = type;         
	m_strName = name;
