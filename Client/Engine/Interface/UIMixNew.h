...
public:
	...
	void	OpenMixNewMasterStone(int type);		// ?????? ????? UI
	void	CloseMixNew();

	bool	IsMasterStoneSorReforgeHammer() { return m_bIsMixMasterStone || m_bIsMixReforgeHammer; };
	...
	void	MixNewMasterStoneRep( int err_type, int success_type, int percent, int max_attack); //dethunter12 adjust 3/8/2023
...
private:
	...
	bool CheckReforgeHammer( CItems* pTargetItem );
