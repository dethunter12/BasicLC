...
// Buff count
#define	BUFF_MAX_COUNT				76
#define	BUFF_GOOD_COUNT				66				//Buff???? ??? 22 - > 30 // ??? ????ø? ???? ??? 30--> 40???? ?ø?
#define	BUFF_BAD_COUNT				10


// Define max char and line of buff informaion 
#define	MAX_BUFFINFO_CHAR			30  // 26 -> 30 wooss 060622
#define	MAX_BUFFINFO_LINE			20
#define	MAX_BUFF_COL				10
#define	MAX_BUFF_ROW				8				//Buff???? ??? 4 - > 5 // [2012/03/02 : Sora] ???? ??? ???? ???? 6 -> 7
...
protected:
	...
	int				m_nBuffSelectedSkill;
	int				m_nBuffSelectedItem;
...
public:
	...
	int 	GetBuffSelectedSkill() { return m_nBuffSelectedSkill; }
	int 	GetBuffSelectedItem() { return m_nBuffSelectedItem; }
