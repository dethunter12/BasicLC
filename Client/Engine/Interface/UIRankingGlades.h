...
#ifndef	UIRANKING_GLADES_H_
#define	UIRANKING_GLADES_H_
#ifdef	PRAGMA_ONCE
	#pragma once
#endif
...
// Desc :
// ----------------------------------------------------------------------------
class CUIRankingGlades : public CUIWindow
{
protected:
...
public:
	...
	void	AddToRankingList(const CTString& strName, INDEX iCubeKillCount, INDEX iJob);
