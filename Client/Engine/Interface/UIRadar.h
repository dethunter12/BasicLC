...
public:
	...
	CUIBase*	m_dominInfo;
	CUIText* 	m_pPointTeamA;
	CUIText* 	m_pPointTeamB;
	CUIImage* 	m_pDominationFlagStatus[3];
	bool		m_pStatusDominationEvent;
	void UpdateDominationInfo(int pointsTeamA, int pointsTeamB, int status);
	void UpdateDominationInfoFlag(int npcIdx, int status);
#endif
private:
