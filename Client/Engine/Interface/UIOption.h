...
public:
	...
	bool checkResolutionExist(PIX width, PIX height);
...
private:
	...
	void _change_notice_log();
#endif
	void _change_bgm();
	void _change_fxsound();
	void _change_show_mob_bar();
	void _change_show_player_bar();
	...
	CUICheckButton*		m_pChkMobsHpBar;
	CUICheckButton*		m_pChkPlayersHpBar;
