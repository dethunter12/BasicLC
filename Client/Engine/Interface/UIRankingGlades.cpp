...
// ----------------------------------------------------------------------------
// Name : CUIRankingGlades()
// Desc : 
// ----------------------------------------------------------------------------
CUIRankingGlades::CUIRankingGlades()
{
}
...
// Desc :
// ----------------------------------------------------------------------------
void CUIRankingGlades::Create( CUIWindow *pParentWnd, int nX, int nY, int nWidth, int nHeight )
{
...
// Desc :
// ----------------------------------------------------------------------------
void CUIRankingGlades::ResetPosition( PIX pixMinI, PIX pixMinJ, PIX pixMaxI, PIX pixMaxJ )
{
...
// Desc :
// ----------------------------------------------------------------------------
void CUIRankingGlades::AdjustPosition( PIX pixMinI, PIX pixMinJ, PIX pixMaxI, PIX pixMaxJ )
{
...
//------------------------------------------------------------------------------
// CUIRankingGlades::SetFocus
// Explain:  
// Date : 2005-03-10(���� 1:02:39) Lee Ki-hwan
//------------------------------------------------------------------------------
void CUIRankingGlades::SetFocus( BOOL bVisible )
{
	CUIWindow::SetFocus( bVisible );
}

void CUIRankingGlades::closeUI()
{
	SetVisible(FALSE);
	ResetRanking();
}
...
// Desc : 
// ----------------------------------------------------------------------------
void CUIRankingGlades::OpenRankingList( )
{	
	if( IsVisible() )
	{		
		return;
	...
	CUIManager::getSingleton()->RearrangeOrder( UI_RANKING_GLADES, TRUE );
}
...
// Desc : 
// ----------------------------------------------------------------------------
void CUIRankingGlades::ResetRanking()
{		
	m_lbRankingList.ResetAllStrings();
	m_sTotal.Clear();
	...
	CUIManager::getSingleton()->RearrangeOrder(UI_RANKING_GLADES, FALSE );
}
...
// Desc : ��� ����� Ŭ�����մϴ�.
// ----------------------------------------------------------------------------
void CUIRankingGlades::ClearRankingList()
{
	if(!m_vectorRankingList.empty())
	{
		m_vectorRankingList.clear();
...
// Desc : Ȯ�� ��ư�� ������ ���� ó��.
// ----------------------------------------------------------------------------
void CUIRankingGlades::PressOKBtn()
{	
}
...
// Desc : ��� ��Ͽ� �߰�
// ----------------------------------------------------------------------------
void CUIRankingGlades::AddToRankingList( const CTString& strName, INDEX iCubeKillCount, INDEX iJob )
{	
...
// Desc : ����� �����մϴ�.
// ----------------------------------------------------------------------------
void CUIRankingGlades::RefreshRankingList( BOOL bInit )
{
	if( !bInit && !IsVisible() )
		return;
...
// Desc :
// ----------------------------------------------------------------------------
void CUIRankingGlades::Render(void)
{
	CDrawPort* pDrawPort = CUIManager::getSingleton()->GetDrawPort();
...
// Desc :
// ----------------------------------------------------------------------------
WMSG_RESULT	CUIRankingGlades::MouseMessage( MSG *pMsg )
{
	if (!IsVisible())
	{
		return WMSG_FAIL;
