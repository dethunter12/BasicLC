...
//Val add auto ignition/pickup to chat
...
// 	m_apUIs[UI_CHATTING]->Create( NULL, 0, 588, CHATTING_WIDTH, CHATTING_HEIGHT );
	...
	m_apUIs[UI_RANKING_PVP] = new CUIRankingPvP;
	m_apUIs[UI_RANKING_PVP]->Create( NULL, 0, 0, RANKING_WIDTH, RANKING_HEIGHT );
#ifdef CUBE_RANKING_12202022
	m_apUIs[UI_RANKING_CUBE] = new CUIRankingCube;
	m_apUIs[UI_RANKING_CUBE]->Create(NULL, 0, 0, RANKING_WIDTH, RANKING_HEIGHT);
#endif
#ifdef GLADES_RANKING_04182023
	m_apUIs[UI_RANKING_GLADES] = new CUIRankingGlades;
	m_apUIs[UI_RANKING_GLADES]->Create(NULL, 0, 0, RANKING_WIDTH, RANKING_HEIGHT);
#endif
...
//	m_apUIs[UI_NEWGUILDSTASH]->Create( NULL, 0, 0, 0, 0 );
	...
	m_apUIs[UI_BOX_OPEN] = new CBoxOpenUI;
	LoadXML("Box_open.xml", m_apUIs[UI_BOX_OPEN]);
	m_apUIs[UI_AUTOFUNC] = new CAutoFuncUI;
	LoadXML("autoselection.xml", m_apUIs[UI_AUTOFUNC]);
	#ifdef BATTLE_PASS_SYSTEM
	m_apUIs[UI_BATTLE_PASS] = new CUIBattlePass;
	LoadXML("BattlePass.xml", m_apUIs[UI_BATTLE_PASS]);
	#endif
#ifdef IDENTIFY_ITEM_02212023
