...
void CUIExchange::PrepareExchange()
{
	...
	for (i = 0; i < DEF_INVENTORY_MAX; ++i)
	{
		...
		else if (i >= (ITEM_COUNT_IN_INVENTORY_NORMAL + ITEM_COUNT_IN_INVENTORY_CASH_1 + ITEM_COUNT_IN_INVENTORY_CASH_2 + ITEM_COUNT_IN_INVENTORY_CASH_3 + ITEM_COUNT_IN_INVENTORY_CASH_4))
		{
			...
			idx = i - (ITEM_COUNT_IN_INVENTORY_NORMAL + ITEM_COUNT_IN_INVENTORY_CASH_2 + ITEM_COUNT_IN_INVENTORY_CASH_2 + ITEM_COUNT_IN_INVENTORY_CASH_3  +ITEM_COUNT_IN_INVENTORY_CASH_4);
		}
		else if (i >= (ITEM_COUNT_IN_INVENTORY_NORMAL + ITEM_COUNT_IN_INVENTORY_CASH_1 + ITEM_COUNT_IN_INVENTORY_CASH_2 + ITEM_COUNT_IN_INVENTORY_CASH_3))
		{
			...
			idx = i - (ITEM_COUNT_IN_INVENTORY_NORMAL + ITEM_COUNT_IN_INVENTORY_CASH_2 + ITEM_COUNT_IN_INVENTORY_CASH_2 + ITEM_COUNT_IN_INVENTORY_CASH_3);
		}
		else if (i >= (ITEM_COUNT_IN_INVENTORY_NORMAL + ITEM_COUNT_IN_INVENTORY_CASH_1 + ITEM_COUNT_IN_INVENTORY_CASH_2))
		{
			...
			idx = i - (ITEM_COUNT_IN_INVENTORY_NORMAL + ITEM_COUNT_IN_INVENTORY_CASH_2 + ITEM_COUNT_IN_INVENTORY_CASH_2);
		}
				...
				( ndX != 0 || ndY != 0 ) )
			{
				...
				else*/ if( !m_bExchReady && m_nSelInvenItemID >= 0 )
				{
...
#endif
					{
						...
						if (m_nSelITab >= INVENTORY_TAB_CASH_3)
							idx += ITEM_COUNT_IN_INVENTORY_CASH_2;
						if (m_nSelITab >= INVENTORY_TAB_CASH_4)
							idx += ITEM_COUNT_IN_INVENTORY_CASH_3;
							//dethunter12 add
						if (m_nSelITab >= INVENTORY_TAB_CASH_5)
							idx += ITEM_COUNT_IN_INVENTORY_CASH_4;
						if (m_nSelITab >= INVENTORY_TAB_CASH_6)
							idx += ITEM_COUNT_IN_INVENTORY_CASH_5;
				...
				else if( IsInsideRect( nX, nY, m_rcInvenSlot ) )
				{
					...
					for (nIdx = (iRowS * EXCH_INVEN_SLOT_COL); nIdx < (iRowE * EXCH_INVEN_SLOT_COL); ++nIdx)
					{
						if( m_pIconsInvenItems[nIdx]->MouseMessage( pMsg ) != WMSG_FAIL )
						{
							if (nIdx >= (ITEM_COUNT_IN_INVENTORY_NORMAL + ITEM_COUNT_IN_INVENTORY_CASH_1 + ITEM_COUNT_IN_INVENTORY_CASH_2 + ITEM_COUNT_IN_INVENTORY_CASH_3 + ITEM_COUNT_IN_INVENTORY_CASH_4 + ITEM_COUNT_IN_INVENTORY_CASH_5))
							{
								m_nSelITab = INVENTORY_TAB_CASH_6; //4-6
								m_nSelInvenItemID = nIdx - (ITEM_COUNT_IN_INVENTORY_NORMAL + ITEM_COUNT_IN_INVENTORY_CASH_1 + ITEM_COUNT_IN_INVENTORY_CASH_2 + ITEM_COUNT_IN_INVENTORY_CASH_3 + ITEM_COUNT_IN_INVENTORY_CASH_4 + ITEM_COUNT_IN_INVENTORY_CASH_5);
							}
							else if (nIdx >= (ITEM_COUNT_IN_INVENTORY_NORMAL + ITEM_COUNT_IN_INVENTORY_CASH_1 + ITEM_COUNT_IN_INVENTORY_CASH_2 + ITEM_COUNT_IN_INVENTORY_CASH_3 + ITEM_COUNT_IN_INVENTORY_CASH_4))
							{
								m_nSelITab = INVENTORY_TAB_CASH_5;
								m_nSelInvenItemID = nIdx - (ITEM_COUNT_IN_INVENTORY_NORMAL + ITEM_COUNT_IN_INVENTORY_CASH_1 + ITEM_COUNT_IN_INVENTORY_CASH_2 + ITEM_COUNT_IN_INVENTORY_CASH_3 + ITEM_COUNT_IN_INVENTORY_CASH_4);
							}
							else if (nIdx >= (ITEM_COUNT_IN_INVENTORY_NORMAL + ITEM_COUNT_IN_INVENTORY_CASH_1 + ITEM_COUNT_IN_INVENTORY_CASH_2 + ITEM_COUNT_IN_INVENTORY_CASH_3))
							{
								m_nSelITab = INVENTORY_TAB_CASH_4;
								m_nSelInvenItemID = nIdx - (ITEM_COUNT_IN_INVENTORY_NORMAL + ITEM_COUNT_IN_INVENTORY_CASH_1 + ITEM_COUNT_IN_INVENTORY_CASH_2 + ITEM_COUNT_IN_INVENTORY_CASH_3 );
							}
							else if (nIdx >= (ITEM_COUNT_IN_INVENTORY_NORMAL + ITEM_COUNT_IN_INVENTORY_CASH_1 + ITEM_COUNT_IN_INVENTORY_CASH_2))
							{
								m_nSelITab = INVENTORY_TAB_CASH_3;
								m_nSelInvenItemID = nIdx - (ITEM_COUNT_IN_INVENTORY_NORMAL + ITEM_COUNT_IN_INVENTORY_CASH_1 + ITEM_COUNT_IN_INVENTORY_CASH_2);
							}
							else if (nIdx >= (ITEM_COUNT_IN_INVENTORY_NORMAL + ITEM_COUNT_IN_INVENTORY_CASH_1))
							{
