...
//	MSGCMD_QUEST_PRIZE,						// 퀘스트 보상
	...
	// wooss 050812
	MSGCMD_CONFIRM_CHANGE_MY_NAME,			// ĳ???? ??????? ??뿩?? ???
	MSGCMD_CONFIRM_CHANGE_MY_NAME_CUSTOM,
	MSGCMD_CONFIRM_CHANGE_GUILD_NAME,		// ??? ??????? ??뿩?? ???
	MSGCMD_CONFIRM_CHANGE_GUILD_NAME_CUSTOM,
	MSGCMD_USE_CHANGE_MY_NAME_ITEM,			// ĳ???? ??????? ???
	MSGCMD_USE_CHANGE_MY_NAME_ITEM_CUSTOM,
	MSGCMD_USE_CHANGE_GUILD_NAME_ITEM,		// ??? ??????? ???
...
//[ttos_2009_7_17]: CHARATER_CHAT_FILTER 캐릭터 채팅 필터
	...
	MSGCMD_OPEN_BOX_REP,
	MSGCMD_LEGACY_SEAL_REMOVER,
	#ifdef DOMINATION_EVENT_SYSTEM
	MSGLCMD_DOMINATION_EVENT_REG,
	#endif
	MSGCMD_TOTAL
};
...
#define		CHANGE_GUILD_NAME_CUSTOM_ITEM 15436
...
#define		CHANGE_MY_NAME_ITEM_CUSTOM 15435
...
#define		INVEN_CASH_KEY3				(16597)
#define		INVEN_CASH_KEY4				(16598)
#define 	INVEN_CASH_KEY5				(16599)
#define		INVEN_CASH_KEY6				(16600)
...
public:
	...
	UIRectUV m_rtNoticePickupItemС;
