...
#include <Engine/Entities/CrcCheck.h> //crc check
...
void CWorld::LoadLOD()
{
	...
	void CWorld::CRCCheck()
{
	CTString fnTemp;
	CTString strFullPath	=	_fnmApplicationPath.FileDir();
	CTString fnBinLod	=	strFullPath + "data\\etc\\binary.lod";

	if(CCrcCheck::LoadCrc(strFullPath, fnBinLod) == false)
	{
