...
ENGINE_API std::string SE_AntHackCompute(std::string path) {
	unsigned char result[MD5_SIZE];
    boost::iostreams::mapped_file_source src(path);
    md5_buffer((const char*)src.data(), src.size(), result);
...
// stackoverflow.com/questions/1220046/how-to-get-the-md5-hash-of-a-file-in-c
ENGINE_API bool SE_AntHack() {

	bool debug = true;

	if (debug != false) {
		if (
			SE_AntHackCompute("Data/Effect/BGEffect.dat").compare("982fd274a9f1b71595bf3ade85aecb10") != 0 ||
			SE_AntHackCompute("Data/Effect/Effect.dat").compare("2423a6c558dfb9099f8e3e4cc45de97c") != 0 ||
			SE_AntHackCompute("Data/Effect/Effect_snd.dat").compare("59d993a499f78bbaf173fa6515998bc8") != 0 ||
			SE_AntHackCompute("Data/Effect/ItemEffect.dat").compare("1857300cc13f248b3e0e90fd451d4391") != 0 ||
			SE_AntHackCompute("Data/Effect/rogue.dat").compare("5a2e58c8b562e3f02d43b2059e93dbc5") != 0 ||
			SE_AntHackCompute("Data/skills.lod").compare("33d17b398ad506092513622a8c7063e1") != 0 ||
			SE_AntHackCompute("Data/ZoneFlag.lod").compare("d707a1b0ec6be1c97c55c015a5edb3b3") != 0 ||
			SE_AntHackCompute("Data/Character/Mage/ma.ba").compare("1b110b35e8996d470b75dd0d90c3ffc3") != 0 ||
			SE_AntHackCompute("Data/Character/Mage/ma.smc").compare("ee2a2d13078268168295fa48fe7b7078") != 0 ||
			SE_AntHackCompute("Data/Character/Healer/hw.ba").compare("10ad34f88fc5d577d8b01465dc7574c5") != 0 ||
			SE_AntHackCompute("Data/Character/Healer/hw.smc").compare("531d17bd88fd609e61512d4ec686ee81") != 0 ||
			SE_AntHackCompute("Data/Character/Knight/ni.ba").compare("9bef828a2969b6fe521d29f41438a5f4") != 0 ||
			SE_AntHackCompute("Data/Character/Knight/ni.smc").compare("7abd971466355084e6653f08accccdea") != 0 ||
			SE_AntHackCompute("Data/Character/NightShadow/ns.ba").compare("c7db8477c1232dbf5543d92e3ce262e0") != 0 ||
			SE_AntHackCompute("Data/Character/NightShadow/ns.smc").compare("b2a69031232469e88ca0d38989217b96") != 0 ||
			SE_AntHackCompute("Data/Character/Rogue/ro.ba").compare("1c7c198435f95b6d0d34a732fd7aa031") != 0 ||
			SE_AntHackCompute("Data/Character/Rogue/ro.smc").compare("4b5d37121b5cd5c8233354636ef97e09") != 0 ||
			SE_AntHackCompute("Data/Character/Sorcerer/so.ba").compare("58b1078c9c68bcf0ea4651b16849ad9d") != 0 ||
			SE_AntHackCompute("Data/Character/Sorcerer/so.smc").compare("c3b7e35f029a02125d04f785f9d6eb20") != 0 ||
			SE_AntHackCompute("Data/Character/Sorcerer/sot1.ba").compare("d2812b107e67db9a1af99be8cb4be550") != 0 ||
			SE_AntHackCompute("Data/Character/Sorcerer/sot1.smc").compare("e7c1cc57d70fbd3f7470d9c2f4217461") != 0 ||
			SE_AntHackCompute("Data/Character/Sorcerer/sot2.ba").compare("d681e3307de68e87bf12ec21fc3d0816") != 0 ||
			SE_AntHackCompute("Data/Character/Sorcerer/sot2.smc").compare("e7cf56dbe214236c4065f6702840a211") != 0 ||
			SE_AntHackCompute("Data/Character/Titan/ti.ba").compare("d0fe02ed6ba59f2957cd3b6f4ad45b06") != 0 ||
			SE_AntHackCompute("Data/Character/Titan/ti.smc").compare("963e3e4a6ce8fe6ed3cc37d6ae904d6f") != 0)
			return false;
	} else {
		std::ofstream file("Setting.txt");
		file << SE_AntHackCompute("Data/Effect/BGEffect.dat"); file << " BGEffect \n"; 
		file << SE_AntHackCompute("Data/Effect/Effect.dat"); file << " Effect \n"; 
		file << SE_AntHackCompute("Data/Effect/Effect_snd.dat"); file << " Effect_snd \n"; 
		file << SE_AntHackCompute("Data/Effect/ItemEffect.dat"); file << " ItemEffect \n"; 
		file << SE_AntHackCompute("Data/Effect/rogue.dat"); file << " rogue \n"; 
	    file << SE_AntHackCompute("Data/skills.lod"); file << " skill \n"; 
		file << SE_AntHackCompute("Data/ZoneFlag.lod"); file << " zone \n";
		file << SE_AntHackCompute("Data/Character/Mage/ma.ba"); file << " ma.ba \n";
		file << SE_AntHackCompute("Data/Character/Mage/ma.smc"); file << " ma.smc \n";
		file << SE_AntHackCompute("Data/Character/Healer/hw.ba"); file << " hw.ba \n";
		file << SE_AntHackCompute("Data/Character/Healer/hw.smc"); file << " hw.smc \n";
		file << SE_AntHackCompute("Data/Character/Knight/ni.ba"); file << " ni.ba \n";
		file << SE_AntHackCompute("Data/Character/Knight/ni.smc"); file << " ni.smc \n";
		file << SE_AntHackCompute("Data/Character/NightShadow/ns.ba"); file << " ns.ba \n";
		file << SE_AntHackCompute("Data/Character/NightShadow/ns.smc"); file << " ns.smc \n";
		file << SE_AntHackCompute("Data/Character/Rogue/ro.ba"); file << " ro.ba \n";
		file << SE_AntHackCompute("Data/Character/Rogue/ro.smc"); file << " ro.smc \n";
		file << SE_AntHackCompute("Data/Character/Sorcerer/so.ba"); file << " so.ba \n";
		file << SE_AntHackCompute("Data/Character/Sorcerer/so.smc"); file << " so.smc \n";
		file << SE_AntHackCompute("Data/Character/Sorcerer/sot1.ba"); file << " sot1.ba \n";
		file << SE_AntHackCompute("Data/Character/Sorcerer/sot1.smc"); file << " sot1.smc \n";
		file << SE_AntHackCompute("Data/Character/Sorcerer/sot2.ba"); file << " sot2.ba \n";
		file << SE_AntHackCompute("Data/Character/Sorcerer/sot2.smc"); file << " sot2.smc \n";
		file << SE_AntHackCompute("Data/Character/Titan/ti.ba"); file << " ti.ba \n";
		file << SE_AntHackCompute("Data/Character/Titan/ti.smc"); file << " ti.smc \n";
		file << "End";
		file.close();
	}
...
//안태훈 수정 시작	//(For Performance)(0.1)
	_pShell->DeclareSymbol("persistent user INDEX g_bRenderDecoration;", &g_bRenderDecoration);//g_bItemLog
