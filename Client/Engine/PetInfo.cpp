...
m_pPetInfo( NULL )
{
	...
	m_pPetInfo[HORSE_CHILD].fRunSpeed								= 25.0f;
	...
	m_pPetInfo[HORSE_BOY].fRunSpeed									= 25.0f;
	...
	m_pPetInfo[HORSE_ADULT].fRunSpeed								= 25.0f;
	...
	m_pPetInfo[DRAGON_CHILD].fRunSpeed								= 25.0f;
	...
	m_pPetInfo[DRAGON_BOY].fRunSpeed								= 25.0f;
	...
	m_pPetInfo[DRAGON_ADULT].fRunSpeed								= 25.0f;
