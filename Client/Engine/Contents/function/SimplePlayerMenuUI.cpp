...
void CSimplePlayerMenuUI::SetMainMenu()
{
	...
	case TYPE_PERSONAL:
		...
		{
			int nStrIndex[5] = { 4592, 4593, 4720, 100053, 139 };
			SetMainMenuList(TYPE_PERSONAL, 5, nStrIndex);
		}
		else
		{
	...
	case TYPE_PARTYLEADER:
		...
		if (pChar->getType() == PREMIUM_CHAR_TYPE_FIRST)
		{
			int nStrIndex[11] = { 4594, 4595, 4596, 4597, 4598, 4599, 4600, 4601, 4602, 100053, 139 };
			SetMainMenuList(TYPE_PARTYLEADER, 11, nStrIndex);
		}	
		else
		{
	...
	case TYPE_PARTYMEMBER:
		...
		if (pChar->getType() == PREMIUM_CHAR_TYPE_FIRST)
		{
			int nStrIndex[5] = { 4599, 4595, 4602, 100053, 139 };
			SetMainMenuList(TYPE_PARTYMEMBER, 5, nStrIndex);
		}
		else
		{
	...
	case TYPE_EXPEDITIONLEADER:
		...
		if (pChar->getType() == PREMIUM_CHAR_TYPE_FIRST)
		{
			int nStrIndex[11] = { 4702, 4703, 4704, 4705, 4706, 4707, 4708, 4709, 4710,100053, 139 };
			SetMainMenuList(TYPE_EXPEDITIONLEADER, 11, nStrIndex);
		}
		else
		{
	...
	case TYPE_EXPEDITIONSUBLEADER:
		...
		if (pChar->getType() == PREMIUM_CHAR_TYPE_FIRST)
		{
			int nStrIndex[6] = { 4606, 4607, 4609, 4610,100053, 139 };
			SetMainMenuList(TYPE_EXPEDITIONSUBLEADER, 6, nStrIndex);
		}
		else
		{
	...
	case TYPE_EXPEDITIONMEMBER:
		...
		if (pChar->getType() == PREMIUM_CHAR_TYPE_FIRST)
		{
			int nStrIndex[5] = { 4606, 4609, 4610,100053, 139 };
			SetMainMenuList(TYPE_EXPEDITIONMEMBER, 5, nStrIndex);
		}
		else
		{
