...
#define	DEF_TELEPORT_MAX_MEMO			25
#define	DEF_TELEPORT_MAX_ROW			10
...
void CTeleportUI::UpdateListItem( int nSlotIdx )
{
	...
	if(pText != NULL)
	{
		...
		else
		{
			...
			strTemp.PrintF( _S(nStringId,"���� or Ȯ��") );
		}		
...
void CTeleportUI::SendTeleportWrite()
{
	...
	if( !((CPlayerEntity*)CEntity::GetPlayerEntity(0))->IsIdle() )
	{
		pUIMgr->GetChattingUI()->AddSysMessage( _S( 789, "�ٸ� �ൿ �߿��� �޸𸮽�ũ���� ����� �� �����ϴ�." ), SYSMSG_ERROR );
		return;
	}

	if (UTIL_HELP()->IsSpecialChar(strTempMemo.str_String) == true)
	{
		pUIMgr->GetChattingUI()->AddSysMessage ( _S( 437, "���忡 ������ �ܾ ���ԵǾ� �ֽ��ϴ�." ) );
		return;
	}
