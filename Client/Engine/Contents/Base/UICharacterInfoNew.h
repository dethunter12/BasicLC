...
private:
	...
	CUIText*	m_PVP_Winer;
	CUIText*	m_PVP_Lose;
	CUIImageArray*	m_pImgArrWiner;
	CUIImageArray*	m_pImgArrLose;
	CUIText*	m_opResistStone;
	CUIText*	m_opResistSturn;
	CUIText*	m_opResistSilent;
	CUIText*	m_absorbPVPDamageRate;
	CUIText*	m_opDecreaseSkillMP;
#ifdef CUBE_RANKING_12202022
	CUIText*	m_opCubePoints;
	CUIText*	m_opCubePlayerKill;
	CUIText*	m_opCubeBossKill;
#endif
	CUIText*	m_skillSpeed;
	enum eTAB_SKILL
	{
		eTAB_SKILL_ITEM = 0,
		eTAB_SKILL_SSKILL,
